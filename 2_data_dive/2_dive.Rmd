...
gene_table <- bind_rows(gene_table,anno[str_detect(anno[["prev.symbols"]],paste("ICL2", collapse="|")),c(24,5,8,9,10)]
                        )
...
# Tricarboxylic Acid (TCA) Cycle & Malate Metabolism Disruption
