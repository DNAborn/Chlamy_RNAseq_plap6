...
for (i in goi$gene_id){
  ...
  g <- ggplot(d, aes(x = media, y = count, color = genotype)) + 
    ...
    scale_color_manual(values=c("grey30","mediumpurple1")) +
    scale_fill_manual(values=c("grey30","mediumpurple1")) +
    theme_bw() +
    ggtitle(s) +
    theme(plot.title = element_text(hjust = 0.5))
...
ggexport(p, filename = "pub_figures/Counts_COQs.pdf",width = 8.2, height = 4.7)
ggsave(p, filename = "pub_figures/Counts_COQs.png",width = 8.2, height = 4.7)
...
for (i in goi$gene_id){
  ...
  g <- ggplot(d, aes(x = media, y = count, color = genotype)) + 
    ...
    scale_y_continuous(trans = "log2") +
    # coord_cartesian(ylim = c(0,2500)) +
    scale_color_manual(values=c("grey30","salmon2")) +
    scale_fill_manual(values=c("grey30","salmon2")) +
    theme_bw() +
    ggtitle(s) +
    theme(plot.title = element_text(hjust = 0.5))
  assign(x = paste("g",n, sep=""),g)
...
ggexport(p, filename = "pub_figures/Counts_cia+rbcl.pdf",width = 8.2, height = 4.7)
ggsave(p, filename = "pub_figures/Counts_cia+rbcl.png",width = 8.2, height = 4.7)
