...
```{r make_results_old, fig.show="hold", out.width="50%", eval=FALSE}
resultsNames(dds)
...
### PQs
```{r plotcounts2, fig.show='hold',out.width="33%"}
library("ggpubr")
...
```{r volcano, eval=FALSE, out.width="50%"}
library(EnhancedVolcano)
...
## Heatmap
```{r heatmap1, fig.height=9, fig.width=6, out.width="80%"}
library("pheatmap")
...
```
#### Cross Plot
```{r Cross, fig.height=6, fig.width=10}
