...
```{r pre_sample_dist, fig.height=8, out.width="100%"}
...
### - Check sample distance
```{r pre_sample_dist2, fig.width=8, out.width="100%"}
sampleDists <- dist(t(assay(vsd)))
...
### - Advanced PCA
```{r pca_advanced2, warning = FALSE, fig.show="hold", out.width="80%", fig.width=6}
vst_dat <- assay(vst(dds))
